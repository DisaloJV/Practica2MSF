...
plt.plot(t,Pp2,'-',linewidth=1,color=[0.271,0.482,0.616],label='Pp(t):Hipertenso')
...
hipoPI = controlador(0.00105606556362311,4044.35324475275,syshipo)
hiperPI = controlador(10,4006.63166620614,syshiper)
...
plt.plot(t,Pp0,'-',linewidth=1,color=[0.902,0.224,0.274],label='Pp(t):Normotenso')
plt.plot(t,Pp1,'-',linewidth=1,color=[0.114,0.208,0.341],label='Pp(t):Hipotenso')
plt.plot(t,Pp3,':',linewidth=3,color=[0.271,0.482,0.616],label='Pp(t):Hipotenso PI')
plt.grid(False) #Se le pone True en caso de querer la cuadricula
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
plt.ylim(-0.6,1.4); plt.yticks(np.arange(-0.6,1.6,0.2))
plt.xlabel('Pp(t)[V]')
...
plt.plot(t,Pp0,'-',linewidth=1,color=[0.902,0.224,0.274],label='Pp(t):Normotenso')
plt.plot(t,Pp1,'-',linewidth=1,color=[0.114,0.208,0.341],label='Pp(t):Hipotenso')
plt.plot(t,Pp4,':',linewidth=3,color=[0.271,0.482,0.616],label='Pp(t):Hipertenso PI')
plt.grid(False) #Se le pone True en caso de querer la cuadricula
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
plt.ylim(-0.6,1.4); plt.yticks(np.arange(-0.6,1.6,0.2))
plt.xlabel('Pp(t)[V]')
